## POWERSUBSR returns the spectral gain using the power subtraction suppression rule

## ref Cappe/Laroche94 (3) (4) (5)

function [G_curr] = powersubsr(X_curr, L_d, alpha, gainfloor)

## alpha typically 1, or > 1 to overestimate noise
